...
- A chain committed through a **mutator call** (`ctx.setState(new A())`) rather than an assignment stays with the F2 fallback, which runs only when nothing else was found.
